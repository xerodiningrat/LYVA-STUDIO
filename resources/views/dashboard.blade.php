        ...
        <div class="dash-app">
            ...
            <div class="dash-content">
                <div class="dash-sidebar">
                    ...
                    <a href="{{ route('profile.edit') }}" data-label="Settings Akun" title="Settings Akun"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 12a5 5 0 1 0-5-5 5 5 0 0 0 5 5Z" /><path d="M20 21a8 8 0 0 0-16 0" /></svg></a>
                </div>
